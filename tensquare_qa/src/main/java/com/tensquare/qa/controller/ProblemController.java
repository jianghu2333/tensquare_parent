...
public class ProblemController {
    ...
    public Result newlist(@PathVariable String labelid, @PathVariable int page, @PathVariable int rows) {
        Page<Problem> problems = problemService.newlist(labelid, page, rows);
    ...
    public Result hotlist(@PathVariable String labelid, @PathVariable int page, @PathVariable int rows) {
        Page<Problem> problems = problemService.hotlist(labelid, page, rows);
        return new Result(true, StatusCode.OK, "查询成功", new PageResult<Problem>(problems.getTotalElements(), problems.getContent()));
    }

    @RequestMapping(value = "/waitlist/{labelid}/{page}/{size}", method = RequestMethod.GET)
    public Result waitlist(@PathVariable String labelid, @PathVariable int page, @PathVariable int rows) {
        Page<Problem> problems = problemService.waitlist(labelid, page, rows);
        return new Result(true, StatusCode.OK, "查询成功", new PageResult<Problem>(problems.getTotalElements(), problems.getContent()));
    }
